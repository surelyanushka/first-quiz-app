...
public class python extends AppCompatActivity {
    ...
    private Repository question_set = new Repository();
            ...
            public void onClick(View view) {
                if(option1.getText().toString() == ans ){
                    ...
                    if(i < no_of_q ) {
                        ...
                        Intent intent = new Intent(python.this, Final_screen.class);
...
//    private void updateRandomNo(int array[]){
//        TheRandom = rand_num.nextInt(no_of_q);
//        appender(TheRandom);
//    }
//    private void appender(int no){
//        int count = 0;
